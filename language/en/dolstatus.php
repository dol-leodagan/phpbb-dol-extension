...
$lang = array_merge($lang, array(
    ...
    'DOL_STATUS_AGO'            => 'ago',
    'DOL_STATUS_THROTTLED'      => 'Too much queries to Backend, please wait %s minutes...',
    'DOL_STATUS_BACKENDINV'     => 'Backend did not reply correctly, try again later or report to administrator...',
    'DOL_STATUS_INVALID'        => 'Data submitted to Backend was invalid...',
    'DOL_STATUS_BACKENDERR'     => 'Backend Error returned, try again later or report to administrator...',
    'DOL_STATUS_BACKENDNOUP'    => 'Backend was not updated, try logging out of Game or report to administrator...',
    'DOL_STATUS_SUCCESS'        => 'Success',
    ...
    'DOL_GAME_ACTION_RESET_SUCCESS' => 'Your account password is successfully changed, please wait for the new password to be sent to your mailbox before login again.',
    ...
    'DOL_GAME_ACTION_KICK_SUCCESS'  => 'Your account will be forcibly disconnected in 60 seconds.',
    ...
    'DOL_GAME_ACTION_NOTME_SUCCESS' => 'The Account is now successfully removed from your pending list.',
    ...
    'DOL_GAME_ACTION_PASSWD_SUCCESS' => 'Your account is now successfully registered to your profile.',
    'DOL_GAME_ACTION_CONFIRM'       => 'Confirm ?',
    'DOL_GAME_ACTION_CANCEL'        => 'Cancel',
    'DOL_GAME_ACTION_CLOSE'         => 'Close',
    'DOL_GAME_ACTION_REFRESH'       => 'Refresh',
    'DOL_GAME_ACTION_BIND'          => 'Move to Bind',
    'DOL_GAME_ACTION_BIND_CONFIRM'  => 'This will move your character to bind if he\'s standing still in-game or offline, continue ?',
    'DOL_GAME_ACTION_BIND_SUCCESS'  => 'Move to Bind request was successfully sent to the server, login again or check your in-game message for success.',
    ...
    'DOL_GAME_CREATEACC_DUPLICATE'  => 'This account name is already used, please choose another one !',
    'DOL_GAME_CREATEACC_SUCCESS'    => 'Your game account is successfully created, you can refresh the page and login with provided credentials.',
    'DOL_GAME_MESSAGE_WRONGFORM'    => 'Form Missing Data...    ',
    'DOL_GAME_MESSAGE_ENTERPASSWD'  => 'Please enter a Password string !',
    'DOL_GAME_MESSAGE_WRONGPASSWD'  => 'Password is Invalid !',
    'DOL_GAME_MESSAGE_ACCOUNTNAME'  => 'Your account name must be 3 characters minimum with letter and number only and begin with a letter...',
    'DOL_GAME_MESSAGE_ACCOUNTCONFIRM' => 'Your account passwords must match...',
    'DOL_GAME_MESSAGE_ACCOUNTPASSWD' => 'Your account password must be 6 characters minimum...',
    'DOL_GAME_MESSAGE_ACCOUNTDEFAULT' => 'Your account default realm is invalid...',
